...
os.environ["OPENAI_API_KEY"] = os.getenv("ANTHROPIC_API_KEY")  # CrewAI uses this env var
os.environ["OPENAI_API_BASE"] = "https://api.anthropic.com/v1"
os.environ["OPENAI_MODEL_NAME"] = "claude-3-5-sonnet-20241022"  # or claude-3-opus-20240229

# Set up Serper API for search (you'll need this)
os.environ["SERPER_API_KEY"] = os.getenv("SERPER_API_KEY")  # Get free key from serper.dev
...
lead_profiling_task = Task(
    ...
    expected_output=(
        ...
        "including company background, key personnel, recent milestones, and identified needs. "
...
personalized_outreach_task = Task(
    ...
    expected_output=(
        ...
        "Each draft should include a compelling narrative that connects our solutions "
